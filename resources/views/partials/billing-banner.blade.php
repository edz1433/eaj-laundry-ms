@isset($billingBanner)
    @php
        ...
        $noticeIcon = $isTrialNotice ? 'sparkles' : ($isDangerNotice ? 'alertTriangle' : 'bell');
        $noticeTitle = $isTrialNotice ? 'Free Trial Active' : ($isDangerNotice ? 'Subscription Warning' : 'Subscription Notice');
    @endphp
    ...
    >
        <div class="relative">
            ...
            >
                <span class="absolute inset-0 rounded-full border-2 {{ $isTrialNotice ? 'border-blue-400/50' : ($isDangerNotice ? 'border-red-500/80' : 'border-orange-500/60') }} animate-ping"></span>
            ...
            >
                <div class="flex items-start gap-3">
                    <div class="flex h-9 w-9 shrink-0 items-center justify-center rounded-md {{ $isTrialNotice ? 'bg-blue-100 text-blue-700 dark:bg-blue-950 dark:text-blue-200' : ($isDangerNotice ? 'bg-red-100 text-red-700 dark:bg-red-950 dark:text-red-200' : 'bg-orange-100 text-orange-700 dark:bg-orange-950 dark:text-orange-200') }}">
